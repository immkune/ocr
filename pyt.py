...
print(f'{Fore.LIGHTWHITE_EX}>{Fore.LIGHTGREEN_EX} Total List = {Fore.LIGHTWHITE_EX}{tot} {Fore.LIGHTMAGENTA_EX}|| {Fore.LIGHTGREEN_EX} Total Thread = {Fore.LIGHTWHITE_EX}{work}\n')
    ...
    try:
        ...
        try:
            ...
            if "An account already exists with this email address." in text:
                ...
                tx.writelines(email)
                tx.close()  
                print(f'{Fore.LIGHTWHITE_EX}[#]{Fore.GREEN} {email} {Fore.LIGHTWHITE_EX}={Fore.LIGHTCYAN_EX} Valid')
                driver.quit()
            ...
            tx.writelines(email)
            tx.close()  
            print(f'{Fore.LIGHTWHITE_EX}[#]{Fore.GREEN} {email} {Fore.LIGHTWHITE_EX}={Fore.LIGHTRED_EX} Die')
            driver.quit()
        ...
        tx.writelines(email)
        tx.close()  
        print(f'{Fore.LIGHTWHITE_EX}[#]{Fore.GREEN} {email} {Fore.LIGHTWHITE_EX}={Fore.LIGHTYELLOW_EX} Die')
        driver.quit()
...
detail = open('valid.txt', 'r')
lines = detail.readlines()
hasil = len(lines)
print(f'{Fore.LIGHTWHITE_EX}>{Fore.LIGHTWHITE_EX} Total Valid = {Fore.LIGHTCYAN_EX}{hasil}')
